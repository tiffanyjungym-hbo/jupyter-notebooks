...
where  f.premiere_date>='2024-04-01'
    and f.premiere_date<'2025-01-01'
...
df_ss.loc[df_ss['title_name']=='Dune: Prophecy', 'medal'] = 'Platinum'
...
display(df_ss[df_ss.title_name=='Beetlejuice Beetlejuice']) 
display(df_ss[df_ss.title_name=='The Watchers']) 
df_ss.loc[df_ss.title_name=='Beetlejuice Beetlejuice','gap'] = 77   
...
for delta_days in delta_days_list:
    ...
    display(df_result[df_result.title_name=='Beetlejuice Beetlejuice'])
...
df_result[df_result.title_name=='Beetlejuice Beetlejuice'].sort_values(by=['region'])
...
df_0, df_0_sum =calc_change(df_result, 0, list_features, df_coef, model_dict,'Beetlejuice Beetlejuice')
df_7, df_7_sum =calc_change(df_result, 7, list_features, df_coef, model_dict,'Beetlejuice Beetlejuice')
df_14, df_14_sum =calc_change(df_result, 14, list_features, df_coef, model_dict,'Beetlejuice Beetlejuice')
df_21, df_21_sum =calc_change(df_result, 21, list_features, df_coef, model_dict,'Beetlejuice Beetlejuice')
