...
def get_days_diff(df_in):
    ...
    # df_in.loc[df_in.days_diff<-60, 'days_diff'] = -60
    return df_in
...
title_removed = ['The Batman','House Party', "Magic Mike's Last Dance"]
title_removed_LATAM = ['House Party']#,'The Batman',  "Magic Mike's Last Dance",'DC League of Super-Pets','Barbie']#, 'Blue Beetle']
title_removed_EMEA = ['House Party','The Batman',  'DC League of Super-Pets']
...
variables = list(df_in[['ln_rfv7','ln_days_diff','ln_gap', 'ln_bo_opening_imputed','ln_production_cost']])
